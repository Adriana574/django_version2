    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('ciudadOestado', models.CharField(choices=[('p', 'Seleccione opción'), ('E', 'Estado de México'), ('C', 'Ciudad de México')], default='p', max_length=100)),
                ('created', models.DateTimeField(auto_now_add=True)),
                ('update', models.DateTimeField(auto_now_add=True)),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('padreT', models.CharField(choices=[('p', 'Seleccione opción'), ('P', 'Padre'), ('M', 'Madre'), ('Tutor', 'Tutor')], default='p', max_length=100)),
                ('created', models.DateTimeField(auto_now_add=True)),
                ('update', models.DateTimeField(auto_now_add=True)),
            ],
            options={
